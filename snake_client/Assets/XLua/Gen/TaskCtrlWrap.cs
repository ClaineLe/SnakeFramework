...
namespace XLua.CSObjectWrap
{
    ...
    public class TaskCtrlWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(TaskCtrl);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to TaskCtrl constructor!");
        ...
        static int _g_get_btnClose(RealStatePtr L)
        {
		    try {
                ...
                TaskCtrl gen_to_be_invoked = (TaskCtrl)translator.FastGetCSObj(L, 1);
