...
namespace XLua.CSObjectWrap
{
    ...
    public class EventDefineWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(EventDefine);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					EventDefine gen_ret = new EventDefine();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to EventDefine constructor!");
        ...
        static int _g_get_OnGuildCreated(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, EventDefine.OnGuildCreated);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_OnGuildCreated(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    EventDefine.OnGuildCreated = (Event<bool>)translator.GetObject(L, 1, typeof(Event<bool>));
