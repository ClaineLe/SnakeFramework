...
//所有Event的基类，实现了一些通用的方法
public abstract class EventRegisterBase
{
    ...
    {
        EventRegisterBase _soruce;
        Delegate _value;
        public HandlerRemover(EventRegisterBase soruce, Delegate value)
        {
            _soruce = soruce;
            _value = value;
        }
...
public abstract class EventRegister : EventRegisterBase
{
...
//一个参数
public abstract class EventRegister<T0> : EventRegisterBase
{
...
//两个参数
public abstract class EventRegister<T0, T1> : EventRegisterBase
{
...
//三个参数
public abstract class EventRegister<T0, T1, T2> : EventRegisterBase
{
...
//四个参数
public abstract class EventRegister<T0, T1, T2, T3> : EventRegisterBase
{
